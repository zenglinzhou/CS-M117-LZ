...
public class SMSActivity extends Activity {
    ...
    public boolean validate(String telNo, String content){
        ...
        if((null==telNo)||("".equals(telNo.trim()))){
            Toast.makeText(this, "Please input a telephone number!",Toast.LENGTH_LONG).show();
            return false;
        }
        if(!checkTelNo(telNo)){
            Toast.makeText(this, "Please input a correct telephone number!",Toast.LENGTH_LONG).show();
            return false;
        }
